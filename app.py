...
def vector_embedding():
    if 'vectors' not in st.session_state:
        ...
        db_dir = 'End-to-End-RAG-Project-using-ObjectBox-and-Langchain/objectbox'
        os.makedirs(db_dir, exist_ok=True)

        st.session_state.embeddings = huggingface_instruct_embedding()
        st.session_state.loader = PyPDFDirectoryLoader(
            'End-to-End-RAG-Project-using-ObjectBox-and-Langchain/us-census-data'
        )
...
if user_input:
    ...
    if "vectors" in st.session_state and st.session_state.vectors is not None:
        ...
        st.error("No vectors found and embedding creation failed.")
